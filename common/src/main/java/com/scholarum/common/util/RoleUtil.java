...
public class RoleUtil {
	...
	public static final String ALL_AUTH = "hasAuthority('ROLE_SCHOLARUM_ADMIN') or hasAuthority('ROLE_SCHOLARUM_SUPERVISOR')"
			...
			+ " or hasAuthority('ROLE_SCHOOL_ADMIN') or hasAuthority('ROLE_SCHOOL_SUPERVISOR') or hasAuthority('ROLE_SCHOOL_FINANCE')"
	...
	public static final String ALL_ADMIN_AUTH = "hasAuthority('ROLE_SCHOLARUM_ADMIN') or hasAuthority('ROLE_SCHOLARUM_SUPERVISOR')"
			+ " or hasAuthority('ROLE_INSTITUTION_ADMIN') or hasAuthority('ROLE_INSTITUTION_SUPERVISOR')"
			+ " or hasAuthority('ROLE_SCHOOL_ADMIN') or hasAuthority('ROLE_SCHOOL_SUPERVISOR')";
	...
	public static final String SCHOOL_AUTH = "hasAuthority('ROLE_SCHOOL_ADMIN') or hasAuthority('ROLE_SCHOOL_SUPERVISOR')"
			+ " or hasAuthority('ROLE_SCHOOL_FINANCE') or hasAuthority('ROLE_SCHOOL_OPS')"
	...
	public static final String INSTITUTION_ADMIN_AUTH = "hasAuthority('ROLE_INSTITUTION_ADMIN') or hasAuthority('ROLE_INSTITUTION_SUPERVISOR')";
	
	public static final String SCHOOL_ADMIN_AUTH = "hasAuthority('ROLE_SCHOOL_ADMIN') or hasAuthority('ROLE_SCHOOL_SUPERVISOR')";
